 ...
 */
final class Version20230302105343 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE formation_domaine (formation_id INT NOT NULL, domaine_id INT NOT NULL, INDEX IDX_3D504FB75200282E (formation_id), INDEX IDX_3D504FB74272FC9F (domaine_id), PRIMARY KEY(formation_id, domaine_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
